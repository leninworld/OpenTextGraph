...
public class ReadFolder_load_checksum_N_taggedNLPdocLevel_from_eachFile {
	
	public static TreeMap<Integer,TreeMap<String,String>> readFolder_load_checksum_N_taggedNLPdocLevel_from_eachFile(
																										String inFolder, 
																										String debugFile, 
																										boolean isSOPprint){
		 ...
		 TreeMap<String,String> mapOut_checkSum_taggedNLP = new TreeMap<String,String>();
		 TreeMap<String,String> mapOut_CompressedSentence_taggedNLP = new TreeMap<String,String>();
		...
		try {
			...
			while(cnt<len_arr_files){
				...
				for(int lno:map_inFile_eachLine.keySet()){
					...
					if(token.length<=2) {
						...
						mapOut_checkSum_taggedNLP.put( token[0],  token[1] );
						mapOut_CompressedSentence_taggedNLP.put( token[2],  token[1] );
				}
				cnt++;
			...
			mapOut.put( 1, mapOut_checkSum_taggedNLP);
			mapOut.put( 2, mapOut_CompressedSentence_taggedNLP);
	...
	public static void main(String[] args) throws IOException {
		 ...
		 String baseFolder="/Users/lenin/Downloads/#problems/p8/Full Article/samples/tmp/tmp/";
		
    	 String inputFileName=baseFolder+"merged_all.txt";
		 String outputFileName=baseFolder+"merged_all_token1_3_normalized.txt";
	}
