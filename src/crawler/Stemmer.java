...
public class Stemmer implements Function<Word,Word> {
  ...
  */
  ...
  public static String stem_2(String s) {
...
//		  System.out.println("inside stem_2 :"+stemmer.getCurrent());
	  }
	  catch(Exception e){
		  e.printStackTrace();
	  }
  ...
  public String stem(String s) {
    ...
    stem();
     ...
     //System.out.println("()())inside stem stemming of word="+s+"<-->is="+toString());
  ...
  public static void main(String[] args) throws IOException {
     ...
     System.out.println( s.stem("collapsed")+" "+s.stem_2("effectively"));
