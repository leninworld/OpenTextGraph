...
0	 * @author John Bauer
	 */
	public class Semantic_Graph {
//	        public static void main(String[] args) {
//	                Tree t = Tree
//	                                .valueOf("(ROOT (S (NP (NP (NNP Bank)) (PP (IN of) (NP (NNP America)))) (VP (VBD called)) (. .)))");
//	                TregexPattern pat = TregexPattern.compile("PP < (NP << America) < PP=remove");
...
//	        }
	        public static void main(String[] args) {
	                ...
	                // other language supported. As of 0, only English and Chinese
	                ...
	                // Same graph, but with a DocId and an index included
	                  graph =// SemanticGraphFactory.generateUncollapsedDependencies(gs, "demo", 0);
	                SemanticGraphFactory.generateUncollapsedDependencies(gs);
